...
int main(int argc, char *argv[]) {
  if (argc == 5) {
	...
	//command = setCommand("GET", "/Users/dcho/Born2Code/DreamXWebserv/webserv/YoupiBanane/index.html");


	string path_info = "/Users/dcho/Born2Code/DreamXWebserv/webserv/YoupiBanane/index.html";
    ...
    if (!strcmp(command[0], "php-cgi")) {
      ...
      env_set["SCRIPT_NAME"] = "/Users/dcho/Born2Code/DreamXWebserv/testcode/tester/cgi_tester";
    }
    ...
    */
    ...
    if (!pid) {
      ...
      //              -> 2) /Users/$(USER)/.brew/bin/php-cgi
        ...
        execve("./tester/cgi_tester", NULL, environ);
      // exit(1);
    } else {
      // close(pipe_fd[1]);
      int nbytes;
